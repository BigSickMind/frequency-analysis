...
class Ui_FrameAnalysis(object):
    ...
    def retranslateUi(self, FrameAnalysis):
        ...
        self.tabAnalysis.setTabText(self.tabAnalysis.indexOf(self.tabResults),
                                    _translate("FrameAnalysis", "Результаты анализа"))
