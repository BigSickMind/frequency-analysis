...
if __name__ == "__main__":
    ...
    command = input()
    print()
    if command == 'watermark' or command == 'w':
    ...
    elif command == 'recover' or command == 'r':
        print("Choose audio file:\n")
        output_audio = input()
        print()
...
#D:\GoogleDrive\Courseworks\4_coursework\Practice\Frequency_analysis\Break Melo.wav
#D:\GoogleDisk\Courseworks\4_coursework\Practice\Frequency_analysis\Break Melo.wav