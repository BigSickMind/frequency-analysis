...
class Ui_FrameDefault(object):
    def setupUi(self, FrameDefault):
        ...
        self.actionFFT = QtWidgets.QAction(FrameDefault)
        ...
        self.menu_analysis.addAction(self.actionFFT)
    ...
    def retranslateUi(self, FrameDefault):
        ...
        self.actionFFT.setText(_translate("FrameDefault", "График спектра"))
        self.actionFFT.setStatusTip(_translate("FrameDefault", "График спектра"))
        ...
        self.actionSpectrum.setText(_translate("FrameDefault", "Спектрограмма"))
